                ...
                <div className='container-fluid d-flex flex-column py-3 m-0 p-0'>
                    ...
                    <form action="">
                        <div className="container py-5" style={{ backgroundColor: window.themeColors.footerBackground.bakgroundFColor }}>
                            ...
                            <h3 className="d-flex py-3 justify-content-center">INFORMACIÓN DE CONTACTO</h3>
                            ...
                            <h3 className="d-flex py-3 justify-content-center">INFORMACIÓN EXTRA</h3>
                            <div>
                                <AccordionComponent buttonText={"Historial Educativo"} buttonClassName=" lightblue custom-btn w-100 py-4 fs-4 m-0">
